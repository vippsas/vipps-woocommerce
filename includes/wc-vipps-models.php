...
require_once( __DIR__ . '/models/WC_Vipps_Charge.php' );
require_once( __DIR__ . '/models/WC_Vipps_Checkout_Session_Customer.php' );
require_once( __DIR__ . '/models/WC_Vipps_Checkout_Session_Merchant_Info.php' );
require_once( __DIR__ . '/models/WC_Vipps_Checkout_Session_Configuration.php' );
require_once( __DIR__ . '/models/WC_Vipps_Checkout_Session.php' );
require_once( __DIR__ . '/models/WC_Vipps_Checkout_Session_Response.php' );
