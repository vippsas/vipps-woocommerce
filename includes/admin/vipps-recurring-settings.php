...
return apply_filters(
	...
	[
		'enabled'                          => [
			...
			'label'       => __( 'Enable Vipps/MobilePay Recurring Payments', 'woo-vipps-recurring' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		],
		'brand'                         => [
			'title'       => __( 'Brand', 'woo-vipps-recurring' ),
			'type'        => 'select',
			'description' => __( 'Controls the payment flow brand (Vipps or MobilePay).', 'woo-vipps-recurring' ),
			'default'     => 'vipps',
			'options'     => [
				'vipps'     => 'Vipps',
				'mobilepay' => 'MobilePay'
		...
		'description'                      => [
			...
			'type'        => 'text',
			'description' => __( 'This controls the description which the user sees during checkout. {brand} is substituted with either Vipps or MobilePay.', 'woo-vipps-recurring' ),
			// translators: {brand}: brand title (Vipps or MobilePay)
			'default'     => __( 'Pay with {brand}.', 'woo-vipps-recurring' ),
		],
		'merchant_serial_number'           => [
			'title'       => __( 'Merchant Serial Number (MSN)', 'woo-vipps-recurring' ),
			'type'        => 'text',
			'description' => __( 'Get your Merchant Serial Number your Vipps/MobilePay developer portal.', 'woo-vipps-recurring' ),
			'default'     => '',
			'desc_tip'    => true,
		],
		'client_id'                        => [
		...
		'default_reserved_charge_status'   => [
			...
			'description' => __( 'The status to give orders when the charge is reserved in Vipps/MobilePay (i.e. tangible goods). Notice: This option only counts for newly signed agreements by the customer. Use the setting below to set the default status for renewal orders.', 'woo-vipps-recurring' ),
			'default'     => 'wc-on-hold',
		...
		'transition_renewals_to_completed' => [
			...
			'description' => __( 'This option will make sure order statuses always transition to "completed" when the renewal charge is completed in Vipps/MobilePay.', 'woo-vipps-recurring' ),
			'default'     => 'no',
		],
