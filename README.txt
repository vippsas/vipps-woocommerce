...
* Enhancement: The subscription description is now prefixed with "[Pending cancellation]" or "[Cancelled]" depending on the subscription's status in the Vipps app.
