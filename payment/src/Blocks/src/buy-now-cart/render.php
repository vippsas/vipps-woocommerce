...
Vipps::instance()->cart_express_checkout_button_html('minicart'); // always print the html, the directive 'data-wp-bind--hidden' above will show or hide it. LP 2026-02-10
echo '</span>';
echo "</div>";
