<?php
/**
 * Vipps/MobilePay Recurring List Table
 */
...
class WC_Vipps_Recurring_Admin_List_Failed_Charges extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$args = WC_Vipps_Recurring_Helper::add_meta_query_to_args( $args, WC_Vipps_Recurring_Helper::META_CHARGE_FAILED, '=', 1, $gateway->use_high_performance_order_storage() );
	...
	/**
	 * Generate HTML for a single row on the Vipps/MobilePay failed charges admin panel.
	 *
