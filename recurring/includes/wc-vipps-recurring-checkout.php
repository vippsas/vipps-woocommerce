...
class WC_Vipps_Recurring_Checkout {
	...
	public function maybe_create_session(): array {
		...
		try {
			...
			$configuration = ( new WC_Vipps_Checkout_Session_Configuration() )
			...
			$allowed_countries = apply_filters( 'woo_vipps_recurring_checkout_countries', $countries, $order->get_id() );
			if ( $allowed_countries ) {
				$configuration->set_countries( [ 'supported' => $allowed_countries ] );
			}
